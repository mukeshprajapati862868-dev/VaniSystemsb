...
// //
// // Gallery images are stored in MongoDB as base64 data.
...
// Also expose uploads through /api/uploads
app.use(
  '/api/uploads',
  express.static(uploadsRoot)
);
  ...
  try {
    ...
    httpServer.listen(
      ...
      () => {
        ...
        console.log(
          `🌐 CORS: vanisystems.in + www + rishabh + localhost`
        );
